exports.resetPasswordMail = (user, rpt)=>{
    return (
        `
        <!DOCTYPE html>
        <html lang="en">
        ...
        <body>
            <div style="display: flex; max-width: 600px; padding: 24px 50px 0px 50px; flex-direction: column; align-items: flex-start; gap: 24px; background: #C1BFCB;">
                ...
                <section  style="display: flex; padding: 48px; flex-direction: column; align-items: center; gap: 24px; align-self: stretch; border-radius: 24px; border: 8px solid #8D88A4; background: #D7D3F2; box-shadow: 0px 0px 20px 0px #1E1E1E;">
                    ...
                    <a href=${rpt} style="all:unset; cursor: pointer; display: flex; padding: 8px 16px; flex-direction: column; justify-content: center; align-items: center; gap: 10px;border-radius: 24px;background: #8D88A4;box-shadow: 0px 4px 0px 0px rgba(141, 136, 164, 0.30);">
                        <p style="color: #D7D3F2;text-align: center;font-family: Itim;font-size: 24px;font-style: normal;font-weight: 400;line-height: normal;margin:0">${rpt}</p>
                    </a>
